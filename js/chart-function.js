...
==================================*/    
    ...
    function chart(){
      /* Layout 1 Token Chat */
      var colors = ['#7d7d7d', '#d47c0c', '#fbbd18', '#8f93e1', '#728c69', '#945c4e'];
      var labels = ["Marketing 6%", "Rewards 2%", "Liquidity 2%", "Team 2%", "Buyback 1%"];
      var data = [6, 2, 2, 2, 1];
      var bgColor = colors;
      var dataChart = {
        labels: labels,
      ...
      legendHolder.innerHTML = legend;
       ...
       /* Layout 2 Token Chat */
      var layout2colors = ['#7d7d7d', '#d47c0c', '#fbbd18', '#8f93e1', '#728c69'];
      var layout2labels = ["Marketing 5%", "Reward 3%", "Liquidity 2%", "Team 1%", "Buyback 1%"];
      var layout2data = [5, 3, 2, 1, 1];
      var layout2data2 = [5, 3, 2, 1, 1];
